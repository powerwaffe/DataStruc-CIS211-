...
public class ArrayBagDemo1
{
    ...
    {
        String[] contentsOfBag = {"A", "A", "B", "A", "C"};
...
//      BagInterface<String> aBag = new ArrayBag<>();
        ...
        testNewCapacity(aBag, contentsOfBag); //new test
    ...
    private static void testNewCapacity(BagInterface<String> aBag, String[] newSize)
    {
        System.out.println("*************Resizing******************");
        System.out.println(newSize.length);
        System.out.println("****************************************");
    }
