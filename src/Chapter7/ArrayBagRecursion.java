...
public final class ArrayBagRecursion<T> implements BagInterface<T>
{
    ...
    public ArrayBagRecursion(int initialCapacity)
    {
    ...
    public ArrayBagRecursion(T[] contents)
    {
