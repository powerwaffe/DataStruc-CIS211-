...
public class LinkedBagDemo1
{
    public static void main(String[] args)
    {
        ...
        BagInterface1<String> aBag = new LinkedBag1<>();
    ...
    private static void testIsEmpty(BagInterface1<String> bag, boolean empty)
    {
    ...
    private static void testAdd(BagInterface1<String> aBag, String[] content)
    {
    ...
    private static void displayBag(BagInterface1<String> aBag)
    {
